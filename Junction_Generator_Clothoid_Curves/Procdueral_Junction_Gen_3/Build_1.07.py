...
for i in range(len(Incident_Roads)):
    for j in range(Incident_Roads[i][-1]):
        Incident_Roads_boundry.append(Incident_Boundry_Road_gen(Incident_Roads[i][j][0][0],Incident_Roads[i][j][1][0],Incident_Roads[i][-3],Incident_Roads[i][-2]))

for i in range(len(Incident_Roads_boundry)):
    Incident_Plotter_boun(Incident_Roads_boundry[i][0][0],Incident_Roads_boundry[i][0][1])
    Incident_Plotter_boun(Incident_Roads_boundry[i][1][0],Incident_Roads_boundry[i][1][1])
