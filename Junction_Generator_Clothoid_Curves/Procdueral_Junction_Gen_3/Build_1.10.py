...
def Initial_incident_Road() -> Tuple[List[List[float]], List[List[float]], float, float, int]:
    ...
    Number_of_Incident_Roads = random.randint(1, Max_num_Incident_Roads - 1)  # 1, 2 or 3 new lanes
...
Max_num_Incident_Roads = 2                  ### max 3 min 2...
