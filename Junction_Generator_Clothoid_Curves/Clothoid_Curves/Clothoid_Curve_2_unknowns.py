...
tangent_angles = compute_tangent_angles(x_vals, y_vals)
...
plt.quiver(x_vals, y_vals, np.cos(tangent_angles), np.sin(tangent_angles), color='red', scale=20, headwidth=3, headlength=4, label='Tangents')
