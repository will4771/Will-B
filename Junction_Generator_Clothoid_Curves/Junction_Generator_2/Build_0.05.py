...
# Remove x and y tick labels (values)
...
def Connection_road_gen(Incident_Roads, Helper_paths):
    Connection_Roads = []
...
Incident_Roads, Helper_paths = Incident_Map_Gen(2) ### num of incident roads +1
Incident_Map_Plot(Incident_Roads, Helper_paths)

#Connection_Roads = Connection_road_gen(Incident_Roads, Helper_paths)
