...
def Clothoid_Curve(a,b,c,d,heading0,heading1): #x0,y0,x1,x2,heading0,heading1
    ...
    bounds = [(0, None), (None, None)]  # L >= 0, A can be any value
...
def Connection_road_gen(Incident):
    ...
    for j in range(len(Incident)-1):
        Connection_Roads.append(Clothoid_Curve(Incident_Roads[0][0][0],Incident_Roads[0][1][0],Incident_Roads[j+1][0][0],Incident_Roads[j+1][1][0],Incident_Roads[0][2],Incident_Roads[j+1][2]))
...
def Connection_road_plotter(Connection_Roads):
    for i in range(len(Connection_Roads)):
        plt.plot(Connection_Roads[i][0],Connection_Roads[i][1] )
      
          

        

Incident_Roads, Helper_paths = Incident_Map_Gen(4)
...
#A,B = Clothoid_Curve(Incident_Roads[0][0][0],Incident_Roads[0][1][0],Incident_Roads[1][0][0],Incident_Roads[1][1][0],Incident_Roads[0][2],Incident_Roads[1][2])
