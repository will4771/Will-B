...
def angle_out(Incident_R): ### Incident_Roads[0]or 1 ..
    x0 = Incident_R[0][0]
    x1 = Incident_R[0][1]
    y0 = Incident_R[1][0]
    y1 = Incident_R[1][1]
...
def angle_in(Incident_R): ### Incident_Roads[0]or 1 ..
    x0 = Incident_R[0][0]
    x1 = Incident_R[0][1]
    y0 = Incident_R[1][0]
    y1 = Incident_R[1][1]
...
def Connection_road_gen(Incident):
    ...
    Connection_Roads.append(Clothoid_Curve(Incident_Roads[0][0][0],Incident_Roads[0][1][0],Incident_Roads[1][0][0],Incident_Roads[1][1][0], angle_out(Incident_Roads[0]), angle_in(Incident_Roads[1])))
    Connection_Roads.append(Clothoid_Curve(Incident_Roads[1][0][0],Incident_Roads[1][1][0],Incident_Roads[2][0][0],Incident_Roads[2][1][0],angle_out(Incident_Roads[1]),angle_in(Incident_Roads[2])))  
    Connection_Roads.append(Clothoid_Curve(Incident_Roads[0][0][0],Incident_Roads[0][1][0],Incident_Roads[2][0][0],Incident_Roads[2][1][0],(Incident_Roads[0][2]) ,(Incident_Roads[2][2])))     

    return Connection_Roads 



Incident_Roads, Helper_paths = Incident_Map_Gen(2) ### 4 + 1 at the momment
...
print(Incident_Roads[0][2],Incident_Roads[1][2],Incident_Roads[2][2])
